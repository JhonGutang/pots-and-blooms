<template>
  <AuthLayout>
    <template #content>
        ...
        <small class="flex justify-center items-center mt-2">Dont have any account? <router-link to="/auth-registration"><v-btn variant="text" size="small" density="compact">Register Now</v-btn></router-link> </small>
    </template>
  </AuthLayout>
</template>
